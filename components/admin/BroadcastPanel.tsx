      ...
      <AnimatePresence>
        {isSimulating && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-900/55 backdrop-blur-md"
          >
            <motion.div 
            ...
            >
              ...
              {simStep > 3 && (
                <motion.div 
                  ...
                  className="bg-emerald-500/10 border border-emerald-500/20 rounded-2xl p-4 flex items-center gap-3 text-emerald-600 dark:text-emerald-400 text-xs font-bold"
                >
