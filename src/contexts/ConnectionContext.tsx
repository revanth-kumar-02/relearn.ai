...
import { syncOfflineData, getUnsyncedCount, getFailedSyncCount } from '../services/api/dataService';
...
export const ConnectionProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const updateCounts = useCallback(() => {
    ...
    import('../services/api/dataService').then(ds => setFailedItems(ds.getFailedSyncItems()));
  }, []);
  ...
  const dismissFailedSync = useCallback((id: string, collection: string) => {
    import('../services/api/dataService').then(ds => {
