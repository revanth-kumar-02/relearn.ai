...
import { Plan, Task, Activity, Notification as AppNotification, UserStats } from '../types/index';
import { useAuth, defaultPreferences } from './AuthContext';
import { generatePlanCoverImage as generatePlanImage } from '../services/ai/imageService';
import { sendBrowserNotification } from '../services/api/notificationService';
import { awardXP, updateStreak, updateSubjectMastery, ensureGamificationStats, XP_REWARDS, XPAwardResult } from '../services/api/gamificationService';
import { 
