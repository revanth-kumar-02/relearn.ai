...
import { ensureGamificationStats, levelProgress, xpForLevel, getBadgesWithStatus } from '../../services/api/gamificationService';
import Icon from '../../components/ui/Icon';

const UserProgressCharts = lazy(() => import('./UserProgressCharts'));
...
const Progress: React.FC = () => {
  ...
  return (
    <div className="pb-24 animate-fade-in">
      ...
      <div className="px-4">
         <Suspense fallback={
            <div className="h-[400px] flex items-center justify-center bg-surface-light dark:bg-surface-dark rounded-xl border border-dashed border-border-light dark:border-border-dark">
